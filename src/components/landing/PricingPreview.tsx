  ...
  const plans = [
    {
      ...
      features: [
        '1 utilisateur',
        'Recherche sur Instagram, YouTube, TikTok',
        'Filtres par localisation, engagement, followers',
        'Accès à 10k profils sélectionnés',
        '40 rapports d\'audience détaillés',
        '40 contacts d\'influenceurs débloqués',
    ...
    },
    {
      ...
      features: [
        '1 utilisateur',
        'Recherche illimitée sur toutes plateformes',
        'Filtres avancés (démographie, intérêts, hashtags)',
        'Base de données complète (250M profils)',
        '200 rapports d\'audience avec données détaillées',
        '200 contacts d\'influenceurs débloqués',
        'CRM intégré pour gestion campagnes',
    ...
    },
    {
      ...
      features: [
        '5 utilisateurs',
        'Toutes les fonctionnalités Agency',
        'Rapports d\'audience illimités',
        'Contacts d\'influenceurs illimités',
        'API access pour intégrations custom',
        'Analyse de faux followers avancée',
        'Suivi ROI et métriques personnalisées',
