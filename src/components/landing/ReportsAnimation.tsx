      ...
      <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl shadow-gray-500/20 p-6 border border-gray-200/50">
        ...
        {!isUnlocked && currentStep === 0 && (
          <div className="text-center mb-6 p-4 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl border border-purple-200">
            ...
            <div className="text-sm font-medium text-purple-900 mb-2">Rapport d'audience disponible</div>
            <div className="text-xs text-purple-700 mb-3">Cliquez pour accéder aux données détaillées</div>
        ...
        {currentStep === 1 && (
          <div className="text-center mb-6 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200 animate-fadeIn">
            ...
            <div className="text-sm font-medium text-green-900">Rapport en cours de génération</div>
