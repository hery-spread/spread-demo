    ...
    >
      ...
      <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl shadow-gray-500/20 p-6 border border-gray-200/50">
        ...
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            <h4 className="font-semibold text-gray-900">Rapport d'Audience</h4>
            <p className="text-xs text-gray-500">Analyse ultra-détaillée</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3 mb-6 p-3 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl">
          ...
          <div>
            <div className="font-medium text-gray-900">
              {reportData.influencer.name}
            </div>
            <div className="text-sm text-gray-600">
              {reportData.influencer.handle}
            </div>
            <div className="text-xs text-gray-500">
              {reportData.influencer.followers.toLocaleString()} followers •{' '}
              {reportData.influencer.platform}
            </div>
          </div>
        </div>
        ...
        {!isUnlocked && currentStep === 0 && (
          <div className="text-center mb-6 p-4 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl border border-purple-200">
            <DocumentChartBarIcon className="w-8 h-8 text-purple-600 mx-auto mb-2" />
            <div className="text-sm font-medium text-purple-900 mb-2">
              Rapport d'audience disponible
            </div>
            <div className="text-xs text-purple-700 mb-3">
              Cliquez pour accéder aux données détaillées
            </div>
        ...
        {currentStep === 1 && (
          <div className="text-center mb-6 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200 animate-fadeIn">
            <DocumentChartBarIcon className="w-8 h-8 text-green-600 mx-auto mb-2" />
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <div className="font-bold text-orange-900">
                    {reportData.audience.engagement.rate}%
                  </div>
                </div>
                <div>
                  <div className="text-xs text-orange-700 mb-1">
                  ...
                  <div className="font-bold text-orange-900">
                    {reportData.audience.engagement.authenticity}%
                  </div>
                </div>
              </div>
            ) : (
        ...
        {currentStep >= 6 && (
          <div className="mt-4 p-4 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl border border-emerald-200 animate-fadeIn">
            ...
            <div className="text-xs text-emerald-700">
              Audience qualifiée • Engagement authentique • Parfait pour votre
              marque
            </div>
          </div>
        )}
