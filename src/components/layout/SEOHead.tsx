...
import { getSEOMetadata, generateHreflangTags, generateStructuredData } from '@/lib/i18n/seo';
...
export default function SEOHead({ pathname = '/' }: SEOHeadProps) {
  ...
  return (
    <Head>
      ...
      <meta property="og:locale" content={language === 'fr' ? 'fr_FR' : language === 'en' ? 'en_US' : 'nl_NL'} />
