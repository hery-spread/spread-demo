...
export default function Sidebar() {
  ...
  return (
    <div className="w-56 bg-white/80 backdrop-blur-xl shadow-xl shadow-gray-500/10 h-full flex flex-col border-r border-gray-200/50">
      {/* Brand Header */}
      <div className="p-5 border-b border-gray-100/50 relative overflow-hidden group">
        ...
        <div className="relative z-10">
          <div className="flex items-center space-x-2.5 mb-1.5">
            <div className="w-8 h-8 bg-gradient-to-br from-purple-600 to-purple-700 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-500/25 transform transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
        ...
        {navigation.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={`
                group relative flex items-center px-3 py-3 text-sm font-medium rounded-2xl 
      ...
      <div className="p-3 border-t border-gray-100/50">
        <div className="space-y-1">
          <Link
            href="/account"
            className={`
              group flex items-center px-2.5 py-1.5 text-xs font-medium rounded-lg
          ...
          >
            <UserIcon
              className={`
                w-3.5 h-3.5 mr-1.5 transition-colors duration-200
